...
\begin{document}
    ...
    The vector space of \textbf{quaternions} is a natural extension of the complex numbers, and quaternions can be used to naturally represent rotations.  A quaternion consists of a \textit{scalar part} and a \textit{vector part}.
