...
\begin{document}
    ...
    Here, we will always write the scalar part \textit{before} the vector part.  Some people write the scalar part after the vector part; this is the only other competing convention.  Quaternions are often seen as an extension of the complex numbers because they are also written as

    \begin{equation}
        q = s + i v_x + j v_y + k v_z
    \end{equation}

    with \( i, j, k \) obeying the identities
