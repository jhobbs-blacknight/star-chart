...
- **Rigid-body mechanics**: quaternions; attitude dynamics

- **Orbital mechanics**: orbital elements; orbital dynamics; perturbation models

- **Estimation**: Bayesian probability; ML, MAP, and MMSE estimators; Kalman filters; extended Kalman filters; smoothers; factor graphs

- **Control**: _coming soon!_
